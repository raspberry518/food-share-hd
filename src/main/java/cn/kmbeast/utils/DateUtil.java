...
public class DateUtil {
    ...
    public static QueryDto startAndEndTime(Integer days) {
        ...
        LocalDateTime nextDayStart = now.minusDays(days).plusDays(1).with(LocalTime.of(0, 0)); // 计算从当前时间往前推 days 天后的下一天的开始时间
        LocalDateTime daysAgoEnd = nextDayStart.minusSeconds(1);    //  回退一秒
